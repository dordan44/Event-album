...
export const messages = {
  he: {
    ...
    "created.emailed": "📬 הקישורים נשלחו גם למייל שלכם",
    "created.dashboardNote": "אפשר לחזור אליהם בכל רגע דרך",
    "created.dashboardLink": "האזור האישי",

    // Host dashboard + login
    "landing.myEvents": "האזור האישי",
    "login.title": "כניסה לאזור האישי",
    "login.sub": "נשלח קוד חד־פעמי למייל שאיתו יצרתם את האירוע.",
    "login.sendCode": "שליחת קוד",
    "login.sending": "שולחים…",
    "login.codeSentTo": "שלחנו קוד בן 6 ספרות אל",
    "login.codeLabel": "הקוד מהמייל",
    "login.verify": "כניסה",
    "login.verifying": "בודקים…",
    "login.changeEmail": "החלפת כתובת",
    "login.resend": "שליחת קוד חדש",
    "login.devCode": "מצב פיתוח — הקוד:",
    "dash.title": "האזור האישי",
    "dash.signedInAs": "מחוברים בתור",
    "dash.logout": "התנתקות",
    "dash.newEvent": "+ אירוע חדש",
    "dash.eventsCount": "אירועים",
    "dash.empty": "אין עדיין אירועים לכתובת הזו.",
    "dash.emptyCta": "יצירת אירוע חדש",
    "dash.manage": "🎛️ לוח ניהול",
    "dash.guestPage": "עמוד אורחים",
    "dash.slideshow": "סליידשואו",
    "dash.photos": "תמונות",
    "dash.approvedCount": "אושרו",
    "dash.pendingCount": "ממתינות",
    "dash.driveConnected": "☁️ Google Drive מחובר",
    "dash.driveNotConnected": "Drive לא מחובר",
    "dash.paid": "שולם",
    "dash.paymentPending": "ממתין לתשלום",
    "dash.copyGuest": "העתקת קישור לאורחים",
    "dash.copied": "הועתק ✓",
  ...
  en: {
    ...
    "created.emailed": "📬 The links were also sent to your email",
    "created.dashboardNote": "You can always find them again in",
    "created.dashboardLink": "your dashboard",

    "landing.myEvents": "My events",
    "login.title": "Sign in to your events",
    "login.sub": "We'll email a one-time code to the address you used at checkout.",
    ...
    "login.devCode": "Dev mode — the code is:",
    "dash.title": "My events",
    "dash.signedInAs": "Signed in as",
    "dash.logout": "Sign out",
    "dash.newEvent": "+ New event",
    "dash.eventsCount": "events",
    "dash.empty": "No events for this address yet.",
    "dash.emptyCta": "Create a new event",
    "dash.manage": "🎛️ Admin dashboard",
    "dash.guestPage": "Guest page",
    "dash.slideshow": "Slideshow",
    "dash.photos": "photos",
    "dash.approvedCount": "approved",
    "dash.pendingCount": "pending",
    "dash.driveConnected": "☁️ Google Drive connected",
    "dash.driveNotConnected": "Drive not connected",
    "dash.paid": "Paid",
    "dash.paymentPending": "Payment pending",
    "dash.copyGuest": "Copy guest link",
    "dash.copied": "Copied ✓",
